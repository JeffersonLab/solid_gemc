...
void analysis_aiml_bg_PVDIS_LD2(string input_filename,string det,bool Is_simsafe=false,bool Is_textfile=false, bool Is_decaycut=false, int factor_background=0,string the_dir=".")
{
gROOT->Reset();
...
//     file_cc_bg=new TFile("solid_SIDIS_He3_moved_full_BeamOnTarget_5e10_filter_output_lgc.root");    
...
//     file_ec_bg=new TFile("solid_SIDIS_He3_moved_full_BeamOnTarget_5e10_filter_output_ec_merge100.root");    
...
// /cache/halla/solid/sim/solid_gemc/PVDIS_JLAB_VERSION_2.5/pass3/solid_PVDIS_LD2_moved_full_BeamOnTarget_1e10_filter.root        
    ...
    file_cc_bg=new TFile("solid_PVDIS_LD2_moved_full_BeamOnTarget_1e10_filter_output_lgc.root");    
    Ngood_cc=3557;
    Nrand_cc=int(6*factor_background); //for lgc background within 50ns, 3557/(1e10/(50e-6/1.6e-19*50e-9))=5.6
    file_ec_bg=new TFile("solid_PVDIS_LD2_moved_full_BeamOnTarget_1e10_filter_output_ec_merge100.root");    
...
//     total filtered event 3990487    
    file_cc_bg=new TFile("farm_solid_SIDIS_He3_moved_BeamOnTarget_0.561e10_skim_HGCwinCF1_output.root");
...
// 	  Is_decay=false;
	  if (hit_p/p_gen>0.8) Is_decay=false;
	}	
