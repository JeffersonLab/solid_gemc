...
void analysis_aiml_bg_SIDIS_He3(string input_filename,string det,bool Is_simsafe=false,bool Is_textfile=false, bool Is_decaycut=false, int factor_background=0,string the_dir=".")
{
gROOT->Reset();
