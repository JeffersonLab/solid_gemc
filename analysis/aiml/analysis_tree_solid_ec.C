...
Bool_t process_tree_solid_ec(TTree *tree_solid_ec,TTree *tree_solid_ec_ps,double *edep_ec_preshower_FA,double *edep_ec_preshower_LA,double *edep_ec_shower_FA,double *edep_ec_shower_LA)
{
//     if(solid_ec_hitn->size() != solid_ec_ps_hitn->size()) cout << "ec and ec_ps not same  " <<  solid_ec_hitn->size() << "\t" << solid_ec_ps_hitn->size() << endl;
...
//       cout << detector_ID << " " << subdetector_ID << " "  << subsubdetector_ID  << " " << component_ID << ", " << solid_ec_avg_z->at(j) << endl; 
      ...
      if (detector_ID==3 && subdetector_ID == 1 && subsubdetector_ID == 0) edep_ec_shower_FA[component_ID] += solid_ec_totEend->at(j);
      if (detector_ID==3 && subdetector_ID == 2 && subsubdetector_ID == 0) edep_ec_shower_LA[component_ID] += solid_ec_totEend->at(j);
...
//       cout << detector_ID << " " << subdetector_ID << " "  << subsubdetector_ID  << " " << component_ID << ", " << solid_ec_ps_avg_z->at(j) << endl; 

      if (detector_ID==3 && subdetector_ID == 1 && subsubdetector_ID == 1) edep_ec_preshower_FA[component_ID] += solid_ec_ps_totEend->at(j);
      if (detector_ID==3 && subdetector_ID == 2 && subsubdetector_ID == 1) edep_ec_preshower_LA[component_ID] += solid_ec_ps_totEend->at(j);
