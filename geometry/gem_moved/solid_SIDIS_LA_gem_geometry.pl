...
my $DetectorName = 'solid_SIDIS_LA_gem';
...
my @PlateZ = ($PlateZ1,$PlateZ2,$PlateZ3,$PlateZ4);
my @Rin    = ($Rin1,$Rin2,$Rin3,$Rin4);
my @Rout   = ($Rout1,$Rout2,$Rout3,$Rout4);
 
my @offrot = (0,0,0,0);  # angular offsets in degrees (w.r.t. center on 12*$n for $n-th sector) 
my $angle_start=-6;
my $angle_width=12;
