...
#solid_gemc solid.gcard -FILTER_HITS=1 -BEAM_P="e-,10.6*GeV,0*deg,0*deg" -SPREAD_P="0*GeV,0*deg,0*deg" -BEAM_V="(0,0,-40)cm" -SPREAD_V="(0.25,0)cm" -ENERGY_CUT=10 -N=2e7 | cat >> out.log
solid_gemc solid.gcard -FILTER_HITS=1 -BEAM_P="e-,10.6*GeV,0*deg,0*deg" -SPREAD_P="0*GeV,0*deg,0*deg" -BEAM_V="(0,0,-40)cm" -SPREAD_V="(0.25,0)cm" -FIELD_VERBOSITY=2 -DISPLACE_FIELDMAP="halbach_16ring_4col_field_map,-6031.6849*mm, 0*mm, 18563.6*mm" -ROTATE_FIELDMAP="halbach_16ring_4col_field_map, 0*deg, 18*deg, 0*deg" -N=1e6 | cat >> out.log
